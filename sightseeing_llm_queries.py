...
def get_itinerary_after_chat(chat_history, sessionid):
    ...
    def run_duration_analysis():
        results['duration_analysis'] = retry_until_success(get_duration_analysis_of_attractions, shortlisted_attractions, chat_history)

    def run_clustering():
        results['clustered_attractions'] = retry_until_success(cluster_groups_by_geographical_data, shortlisted_attractions, chat_history)

    def run_timing_analysis():
        results['time_based_attractions'] = retry_until_success(get_timings_for_attractions, shortlisted_attractions, chat_history)

    def run_budget_analysis():
        results['budget_reasoned_attractions'] = retry_until_success(get_budget_reasoning_for_attractions, shortlisted_attractions, chat_history)
